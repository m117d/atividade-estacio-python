...
ctk.CTkButton(frame_esquerda, text="Criar Tabela", command=criar_tabela).pack(fill="x")
ctk.CTkButton(frame_esquerda, text="Criar Pessoa", command=abrir_criar_pessoa).pack(fill="x")
ctk.CTkButton(frame_esquerda, text="Buscar Pessoa", command=abrir_buscar_pessoa).pack(fill="x")
